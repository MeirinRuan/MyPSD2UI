...
namespace MyPSD2UI.Operate
{
    ...
    m_HeadBytes[13], m_HeadBytes[12] }, 0);
                    }
                    set
                    {
    ...
    m_HeadBytes[17], m_HeadBytes[16], m_HeadBytes[15], m_HeadBytes[14] }, 0);
                    }
                    set
                    {
                ...
                public uint Width
                {
                    ...
                    get
                    {
                        ...
                        return BitConverter.ToUInt32(new byte[] {
    m_HeadBytes[21], m_HeadBytes[20], m_HeadBytes[19], m_HeadBytes[18] }, 0);
                    }
                    set
                    {
                ...
                public ushort BitsPerPixel
                {
                    ...
                    get
                    {
                        ...
                        return BitConverter.ToUInt16(new byte[] {
    m_HeadBytes[23], m_HeadBytes[22] }, 0);
                    }
                    set
                    {
                ...
                public ushort ColorMode
                {
                    ...
                    get
                    {
                        ...
                        return BitConverter.ToUInt16(new byte[] {
    m_HeadBytes[25], m_HeadBytes[24] }, 0);
                    }
                    set
                    {
            ...
            private class ColorModel
            {
                ...
                public uint BIMSize
                {
                    ...
                    get
                    {
                        ...
                        return BitConverter.ToUInt32(new byte[] {
    m_BIMSize[3], m_BIMSize[2], m_BIMSize[1], m_BIMSize[0] }, 0);
                    }
                    set
                    {
    ...
    m_Value[1], m_Value[0] }, 0);
                ...
                public uint hResUnit
                {
                    ...
                    get
                    {
                        ...
                        return BitConverter.ToUInt32(new byte[] {
    m_Value[5], m_Value[4], m_Value[3], m_Value[2] }, 0);
                    }
                    set
                    {
    ...
    m_Value[9], m_Value[8] }, 0);
                ...
                public uint vResUnit
                {
                    ...
                    get
                    {
                        ...
                        return BitConverter.ToUInt32(new byte[] {
    m_Value[13], m_Value[12], m_Value[11], m_Value[10] }, 0);
                    }
                    set
                    {
    ...
    m_Value[15], m_Value[14] }, 0);
            ...
            public void NewPsd()
            {
                ...
                m_Head = new PSDHEAD(new byte[] {
    0x38, 0x42, 0x50, 0x53, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x01, 0x2C, 0x00, 0x00, 0x01, 0xB4, 0x00, 0x08, 0x00, 0x03 });
